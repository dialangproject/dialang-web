...
class DialangWebStack extends Stack {
  ...
  constructor(scope, id, props) {
    ...
    api.root.addMethod("POST", indexPageIntegration, methodOptions);
    api.root.addResource("settl").addMethod("GET", new apigw.LambdaIntegration(setTLFunction), methodOptions);
