...
object BasicLTIConstants {
	...
	val CONTEXT_TYPE_COURSE_OFFERING = "CourseOffering"
	val CONTEXT_TYPE_COURSE_SECTION = "CourseSection"
	val CONTEXT_TYPE_COURSE_TEMPLATE = "CourseTemplate"
	val CONTEXT_TYPE_GROUP = "GROUP"
	 ...
	 * tool.
	 */
	val LAUNCH_PRESENTATION_DOCUMENT_TARGET = "launch_presentation_document_target"
	/**
	 ...
	 * displayed.
	 */
	val LAUNCH_PRESENTATION_HEIGHT = "launch_presentation_height"
	/**
	 ...
	 */
	val LAUNCH_PRESENTATION_LOCALE = "launch_presentation_locale"
	/**
	 ...
	 */
	val LAUNCH_PRESENTATION_RETURN_URL = "launch_presentation_return_url"
	/**
	 ...
	 * displayed.
	 */
	val LAUNCH_PRESENTATION_WIDTH = "launch_presentation_width"
	/**
	 ...
	 */
	val LAUNCH_PRESENTATION_CSS_URL = "launch_presentation_css_url"
	/**
	 ...
	 */
	val LIS_PERSON_CONTACT_EMAIL_PRIMARY = "lis_person_contact_email_primary"
	/**
	 ...
	 * meaning of the content in these fields is defined by LIS.
	 */
	val LIS_PERSON_NAME_FAMILY = "lis_person_name_family"
	/**
	 ...
	 * meaning of the content in these fields is defined by LIS.
	 */
	val LIS_PERSON_NAME_FULL = "lis_person_name_full"
	/**
	 ...
	 * meaning of the content in these fields is defined by LIS.
	 */
	val LIS_PERSON_NAME_GIVEN = "lis_person_name_given"
	 ...
	 */
	val LIS_PERSON_SOURCEDID = "lis_person_sourcedid"
	 ...
	 */
	val LIS_COURSE_OFFERING_SOURCEDID = "lis_course_offering_sourcedid"
	val LIS_COURSE_SECTION_SOURCEDID = "lis_course_section_sourcedid"
     ...
     * it does not support.  
	 */
	val LIS_OUTCOME_SERVICE_URL = "lis_outcome_service_url"
	 ...
	 */
	val LIS_RESULT_SOURCEDID = "lis_result_sourcedid"
    ...
    */
	val TOOL_CONSUMER_INFO_PRODUCT_FAMILY_CODE = "tool_consumer_info_product_family_code"
    ...
    * The Tool Provider should be flexible when parsing this field.  This parameter is optional but recommended.
     ...
     */
	val TOOL_CONSUMER_INFO_VERSION = "tool_consumer_info_version"
	 ...
	 */
	val TOOL_CONSUMER_INSTANCE_CONTACT_EMAIL = "tool_consumer_instance_contact_email"
	/**
	 * tool_consumer_instance_description=University of School (LMSng)
	 * <p>
	 * This is a user visible field - it should be about the length of a line.
	 */
	val TOOL_CONSUMER_INSTANCE_DESCRIPTION = "tool_consumer_instance_description"
	// global settings
	/**
	 ...
	 */
	val TOOL_CONSUMER_INSTANCE_GUID = "tool_consumer_instance_guid"
	/**
	 * tool_consumer_instance_name=SchoolU
	 * <p>
	 * This is a user visible field - it should be about the length of a column.
	 */
	val TOOL_CONSUMER_INSTANCE_NAME = "tool_consumer_instance_name"
	/**
	 * Missing from implementation guide. Needs documentation. Not required, but
	 * "tasty".
	 */
	val TOOL_CONSUMER_INSTANCE_URL = "tool_consumer_instance_url"
	 ...
	 */
	val EXT_SAKAI_PROVIDER_EID = "ext_sakai_provider_eid"

	/**
	 * Utility array useful for validating property names when building launch
	 * data.
	 */
	val validPropertyNames = List(CONTEXT_ID,
